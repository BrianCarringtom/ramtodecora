...
<body data-spy="scroll" data-target=".navbar" data-offset="56">
    ...
    <div id="carrusel" class="container-fluid position-relative">
        <h2 class="text-center carrusel-titulo">MANTELERIAS</h2>
    ...
    <div class="container-products">
        <div class="card-product" data-name="Mantelerias 1" data-price="100" data-image="../assets/alfombras2.jpg">
            ...
            <div class="content-product">
                <h3>Mantelerias 1</h3>
                <p>Precio: $100</p>
                <button class="btn btn-comprar" onclick="addToCart('Mantelerias 1', 100, '../assets/alfombras2.jpg')">Comprar</button>
            </div>
        </div>
    </div>

...
<body data-spy="scroll" data-target=".navbar" data-offset="56">
    ...
    <div id="carrusel" class="container-fluid position-relative">
        <h2 class="text-center carrusel-titulo">PISOS</h2>
    ...
    <div class="container-products">
        <div class="card-product" data-name="Pisos 1" data-price="100" data-image="../assets/alfombras2.jpg">
            <div class="container1-img">
                <img src="../assets/alfombras2.jpg" alt="Pisos 1">
            </div>
            <div class="content-product">
                <h3>Pisos 1</h3>
                <p>Precio: $100</p>
                <button class="btn btn-comprar" onclick="addToCart('Pisos 1', 100, '../assets/alfombras2.jpg')">Comprar</button>
            </div>
        </div>
    </div>

...
<body data-spy="scroll" data-target=".navbar" data-offset="56">
    ...
    <div id="carrusel" class="container-fluid position-relative">
        <h2 class="text-center carrusel-titulo">PINTURAS</h2>
    ...
    <div class="card-product" data-name="Pinturas 1" data-price="100" data-image="../assets/alfombras2.jpg">
            <div class="container1-img">
                <img src="../assets/alfombras2.jpg" alt="Pinturas 1">
            </div>
            <div class="content-product">
                <h3>Pinturas 1</h3>
                <p>Precio: $100</p>
                <button class="btn btn-comprar" onclick="addToCart('Pinturas 1', 100, '../assets/alfombras2.jpg')">Comprar</button>
            </div>
        </div>
    </div>

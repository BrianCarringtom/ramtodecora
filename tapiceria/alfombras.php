...
<html lang="es">
  <head>
    ...
    <meta
      name="description"
      content="RAMTO Decoración - Soluciones en decoración y tapicería."
    />
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a
                ...
                href="../decoracion/decoracion.php"
                id="navbarDecoracion"
                role="button"
              >
                DECORACIÓN
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDecoracion">
                <a
                  class="dropdown-item"
                  href="../decoracion/cortinasypercianas.php"
                  >Cortinas y Persianas</a
                >
                <a class="dropdown-item" href="../decoracion/acabados.php"
                  >Acabados</a
                >
                <a class="dropdown-item" href="../decoracion/pisos.php"
                  >Pisos</a
                >
                <a class="dropdown-item" href="../decoracion/pinturas.php"
                  >Pinturas</a
                >
                <a class="dropdown-item" href="../decoracion/mantelerias.php"
                  >Manteleria</a
                >
                <a class="dropdown-item" href="../decoracion/plantas.php"
                  >Plantas</a
                >
                <a class="dropdown-item" href="../decoracion/exterior.php"
                  >Exterior</a
                >
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../promociones/promociones.php"
                >PROMOCIONES</a
              >
            </li>
            <li class="nav-item">
    ...
    <div class="container-products">
      <div class="card-product" data-name="Alfombra 1" data-price="100">
        ...
        <div class="content-product">
          ...
          <button
            ...
            onclick="addToCart('Alfombra 1', 100)"
          >
            Comprar
          </button>
        </div>
      ...
      <div class="card-product" data-name="Alfombra 2" data-price="200">
        ...
        <div class="content-product">
          ...
          <button
            class="btn btn-comprar"
            onclick="addToCart('Alfombra 2', 200)"
          >
            Comprar
          </button>
        </div>
      ...
      <div class="card-product" data-name="Alfombra 3" data-price="300">
        ...
        <div class="content-product">
          ...
          <button
            class="btn btn-comprar"
            onclick="addToCart('Alfombra 3', 300)"
          >
            Comprar
          </button>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                Dirección: 7 A. Pte. Nte. 646 Col. Centro, Colón 29000 Tuxtla
                Gutierrez, Chis.
              </li>
            </ul>
          </div>
          <div class="col-md-4">
            ...
            <a href="https://www.facebook.com/ramtodecora" class="social-link"
              ><i class="fab fa-facebook-f"></i
            ></a>
            <a href="https://www.instagram.com/ramtodecora/" class="social-link"
              ><i class="fab fa-instagram"></i
            ></a>
            <a href="https://www.twitter.com/ramtodecora/" class="social-link"
          ...
          <div class="col-md-4">
            <h5>Descripcion</h5>
            <p>
              Somos una empresa comercializadora, diseñadora y productora de
              artículos de decoración, limpieza y el recubrimiento de teflón
              para el cuidado de los tapices.
            </p>
          </div>
        </div>
        <div class="row mt-4">
          <div class="col-12">
            <p class="m-0">
              &copy; 2023 RAMTO Decoración. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
